...
public class app extends Application {
    ...
    public static void egCreateScenes()
    {
        ...
        ListScenes.put(SCENE_MENU_ABOUT, new ASceneMenuAbout());
    ...
    public static void egCreateProgressEvents() {
        ...
        egDefineProgressEvent("s45_open_door", 0).addHint( R.drawable.hint_s45_open_door );
        egDefineProgressEvent("s5_cheese_take", 0).addHint( R.drawable.hint_s5_cheese_take );
        egDefineProgressEvent("s4_apple_take", 0).addHint( R.drawable.hint_s4_apple_take );
        egDefineProgressEvent("s4_mouse_owl", 0).addHint( R.drawable.hint_s4_mouse_owl );
        egDefineProgressEvent("s4_scroll_take", 0).addHint( R.drawable.hint_s4_scroll_take );
        egDefineProgressEvent("s5_scroll_give", 0).addHint( R.drawable.hint_s5_scroll_give );
        egDefineProgressEvent("s5_dagger_take", 0).addHint( R.drawable.hint_s5_cheese_take );
        egDefineProgressEvent("s2_worm_take", 0).addHint( R.drawable.hint_s2_worm_take );
        egDefineProgressEvent("s2_mushroom_take", 0).addHint( R.drawable.hint_s2_mushroom_take );
        egDefineProgressEvent("s5_ingridients", 0).addHint( R.drawable.hint_s5_ingridients );
        egDefineProgressEvent("s5_potion_appear", 0);
        egDefineProgressEvent("s5_potion_take", 0).addHint( R.drawable.hint_s5_potion_take );
        egDefineProgressEvent("s1_potion_give", 0).addHint( R.drawable.hint_s1_potion_give );
        egDefineProgressEvent("s1_bone_solve", 0).addHint( R.drawable.hint_s1_bone_solve );

        egDefineProgressEvent("s5_banner_take", 0).addHint( R.drawable.hint_s5_banner_take );
        egDefineProgressEvent("s5_banner_look", 0).addHint( R.drawable.hint_s5_banner_look );
        egDefineProgressEvent("s2_chest1_open", 0).addHint( R.drawable.hint_s2_chest1_open );
        egDefineProgressEvent("s2_shovel_take", 0).addHint( R.drawable.hint_s2_shovel_take );
        egDefineProgressEvent("s2_shovel_dig", 0).addHint( R.drawable.hint_s2_shovel_dig );
        egDefineProgressEvent("s2_bone_take", 0).addHint( R.drawable.hint_s2_bone_take );
        egDefineProgressEvent("s1_bone_give", 0).addHint( R.drawable.hint_s1_bone_give );
        egDefineProgressEvent("s3_skeleton_appear", 0);
        egDefineProgressEvent("s1_fish_solve", 0).addHint( R.drawable.hint_s1_fish_solve );
        egDefineProgressEvent("s2_branch_take", 0).addHint( R.drawable.hint_s2_branch_take );
        egDefineProgressEvent("s2_branch_cut", 0).addHint( R.drawable.hint_s2_branch_cut );
        egDefineProgressEvent("s2_rope_take", 0).addHint( R.drawable.hint_s2_shovel_take );
        egDefineProgressEvent("s2_worm2_take", 0).addHint( R.drawable.hint_s2_worm2_take );
        egDefineProgressEvent("s3_frod_make", 0);
        egDefineProgressEvent("s3_frodworm_make", 0).addHint( R.drawable.hint_s3_frod_make );
        egDefineProgressEvent("s3_skeleton_fish", 0).addHint( R.drawable.hint_s3_skeleton_fish );
        egDefineProgressEvent("s1_fish_give", 0).addHint( R.drawable.hint_s1_fish_give );
        egDefineProgressEvent("s5_cat_appear", 0);
        egDefineProgressEvent("s1_ring_solve", 0).addHint( R.drawable.hint_s1_ring_solve );
        egDefineProgressEvent("s3_flag_make", 0).addHint( R.drawable.hint_s3_flag_make );
        egDefineProgressEvent("s3_flag_put", 0).addHint( R.drawable.hint_s3_flag_put );
        egDefineProgressEvent("s3_chest2_hint", 0).addHint( R.drawable.hint_s3_chest2_hint );
        egDefineProgressEvent("s3_chest2_open", 0).addHint( R.drawable.hint_s3_chest2_open );
        egDefineProgressEvent("s3_ring_take", 0).addHint( R.drawable.hint_s3_ring_take );
        egDefineProgressEvent("s1_ring_give", 0).addHint( R.drawable.hint_s3_ring_give );
        egDefineProgressEvent("s4_princess_appear", 0);
        egDefineProgressEvent("s4_bookcase_moved", 0);
        egDefineProgressEvent("s5_broom_take", 0).addHint( R.drawable.hint_s5_broom_take );
        egDefineProgressEvent("s4_broom_use", 0).addHint( R.drawable.hint_s4_broom_use );
        egDefineProgressEvent("s4_door_hint", 0).addHint( R.drawable.hint_s4_door_hint );
        egDefineProgressEvent("s4_door_open", 0).addHint( R.drawable.hint_s4_door_open );
    }
